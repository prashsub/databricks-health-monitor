...
|------|------------|-------|
| **PA-01** Unity Catalog (no HMS) | [ ] Compliant [ ] Exception Needed | |
| **PA-02** Delta Lake format | [ ] Compliant [ ] Exception Needed | |
| **PA-03** Serverless compute | [ ] Compliant [ ] Exception Needed | |
| **PA-04** Asset Bundles | [ ] Compliant [ ] Exception Needed | |
| **PA-09** Secrets in scopes | [ ] Compliant [ ] Exception Needed | |
