...
| ID | Rule | Severity |
|----|------|----------|
| **DS-01** | Unity Catalog for all shared assets | Critical |
| **DS-02** | Prefer Databricks-to-Databricks | Critical |
| **DS-03** | Never share PII without filters | Critical |
| **DS-04** | Define retention/revocation policies | Critical |
| **DS-05** | Enable audit logging | Critical |
| **DS-06** | Short-lived tokens (open sharing) | Required |
| **DS-07** | Share views, not base tables | Required |
