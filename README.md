...
└──────────────────────┬──────────────────────────────────────────────────┘
        ...
        ▼               ▼               ▼               ▼               ▼             ▼
  ┌──────────┐   ┌──────────┐   ┌──────────┐   ┌──────────┐   ┌──────────┐   ┌──────────┐
  │ 🤖 ML    │   │ 🔍 Lake  │   │ 💬 Genie │   │ 📊 AI/BI │   │ 🔔 Alert │   │ 🤝 Agent │
  │ Models   │   │house Mon │   │ Spaces   │   │Dashboard │   │Framework │   │Framework │
  ├──────────┤   ├──────────┤   ├──────────┤   ├──────────┤   ├──────────┤   ├──────────┤
  │ 25 models│   │8 monitors│   │ 6 spaces │   │ 12 tabs  │   │ 60+ SQL  │   │LangGraph │
  │ 5 domains│   │210 metric│   │ 60 TVFs  │   │ 65+ wdgt │   │ alerts   │   │5 workers │
  │ Auto inf.│   │Profile   │   │ 10 MVs   │   │ Unified  │   │ Config   │   │Lakebase  │
  │          │   │& Drift   │   │Uses ↑    │   │          │   │          │   │          │
  └──────────┘   └──────────┘   └──────────┘   └──────────┘   └──────────┘   └──────────┘
```
