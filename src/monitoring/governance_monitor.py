...
def create_governance_monitor(workspace_client, catalog: str, gold_schema: str, spark=None):
    ...
    try:
        ...
        monitor = create_time_series_monitor(
            ...
            #   - source_table_catalog: "Lineage by source catalog"
            #   - source_type: "Source type breakdown (TABLE/PATH)"
            slicing_exprs=[
                "workspace_id",
                "entity_type",
                "created_by",
...
def main():
    ...
    print(f"  Slicing:         workspace_id, entity_type, created_by, source_table_catalog, source_type")
