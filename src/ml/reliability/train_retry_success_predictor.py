...
def train_model(X_train, X_test, y_train, y_test):
    print("\nTraining model...")
    # base_score=0.5 required for logistic loss when label distribution is extreme
    hyperparams = {"n_estimators": 100, "max_depth": 6, "learning_rate": 0.1, "random_state": 42, "eval_metric": "logloss", "base_score": 0.5}
...
def main():
    ...
    try:
        ...
        result = log_model_with_features(
            ...
            MODEL_NAME, DOMAIN, "classification", ALGORITHM, "retry_success_prediction",
